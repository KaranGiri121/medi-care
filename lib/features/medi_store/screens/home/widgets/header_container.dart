        ...
        CustomAppBar(
          ...
          title: ListTile(
            ...
            subtitle: Text(
              ...
              style: Theme.of(context).textTheme.bodySmall!.copyWith(color: isBackgroundDark ? Colors.white : null ),
            ),
          ),
          action: [Icon(Iconsax.shopping_cart,color: isBackgroundDark ? Colors.white : null )],
        ),
        const SizedBox(height: AppSize.spaceItems),
        SearchContainer(searchText: 'Search Medicine',isBackgroundDark: isBackgroundDark,),
        const SizedBox(height: AppSize.spaceItems),
         Padding(
          padding: const EdgeInsets.only(left: AppSize.defaultPadding),
          child: Column(
            children: [
              SectionHeading(title: 'Categories',isBackgroundDark: isBackgroundDark,),
              const SizedBox(height: AppSize.spaceItems),
              HomeCategories(isBackgroundDark: isBackgroundDark,),
              const SizedBox(height: AppSize.spaceItems),
            ],
          ),
        ),
